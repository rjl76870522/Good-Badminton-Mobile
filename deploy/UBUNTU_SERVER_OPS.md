...
The Quadro RTX 5000 16 GB server is configured for three concurrent analyses:

```ini
Environment=ANALYSIS_WORKERS=3
```
...
GPU memory. Do not raise the production value above 3 without repeating the
